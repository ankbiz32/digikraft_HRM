              ...
              <div class="row well">
                <div class="col-md-12">
                  <div class="form-group row">
                    ...
                    <div class="col-md-9">
                      <input type="text" name="basic" class="form-control" id="" value="" readonly required>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    <label class="control-label text-left col-md-3">Bonus
                    </label>
                    <div class="col-md-9">
                      <input type="number" name="bonus" class="form-control" id="" value="0" required>
                    </div>
                  </div>
                  <div class="form-group row">
