		<style>
			#sidebarnav li>a , #sidebarnav li>a i{
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
						...
						<!-- <li><a href="<?php echo base_url(); ?>invoice"><i class="fa fa-sticky-note"></i> <span class="hide-menu">Proposal <span class="hide-menu">  </a></li>

						<li><a href="<?php echo base_url(); ?>invoice"><i class="fa fa-quote-right"></i> <span class="hide-menu">Quotation <span class="hide-menu">  </a></li> -->
