										...
										<div class="row">
											...
											<div class="col-md-2">
												<div class="form-group">
													...
													<input type="text" class="form-control datepicker pl-3" value="<?=date('Y-m-d',strtotime($invoice->due_date))?>" name="due_date" placeholder="Enter Invoice due Date" required>
												</div>
											</div>
										</div>
