...
<?php $this->load->view('backend/sidebar'); ?>
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor"><i class="fa fa-user" style="color:#1976d2"></i> <?php echo $basic->first_name .' '.$basic->last_name; ?></h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item"><a href="<?=base_url('employee')?>">Employees</a></li>
                        <li class="breadcrumb-item active"><?php echo $basic->first_name?></li>
                    </ol>
                </div>
            </div>
                    ...
                    <div class="col-lg-12 col-xlg-12 col-md-12">
                        <div class="card">
                            ...
                            <ul class="nav nav-tabs profile-tab" role="tablist">
                                ...
                                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#bank" role="tab" style="font-size: 14px;"> Bank Info</a> </li>
                                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#document" role="tab" style="font-size: 14px;"> Documents</a> </li>
                                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#salary" role="tab" style="font-size: 14px;"> Salary Info</a> </li>
                                                ...
                                                <div class="col-md-4">
													<div class="card">
														...
														<div class="card-body"> <small class="text-muted">Email address </small>
															...
															<a class="btn btn-circle btn-secondary" href="<?php if(!empty($socialmedia->linkedin)) echo $socialmedia->linkedin ?>" target="_blank"><i class="fa fa-linkedin"></i></a>
				                                ...
				                                <form class="row" action="Update" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group col-md-4 m-t-10">
                                                        ...
                                                        <select name="blood" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> value="<?php echo $basic->em_blood_group; ?>" class="form-control custom-select">
                                                            <option value="<?php echo $basic->em_blood_group; ?>" hidden><?php echo $basic->em_blood_group; ?></option>
				                                    ...
				                                    <div class="form-group col-md-4 m-t-10">
				                                        ...
				                                        <select name="gender" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> class="form-control custom-select">
				                                            ...
				                                            <option value="<?php echo $basic->em_gender; ?>" hidden><?php echo $basic->em_gender; ?></option>
                                                   ...
                                                   <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?>  <?php } else { ?> 
                                                    <div class="form-group col-md-4 m-t-10">
                                                        ...
                                                        <select name="role" class="form-control custom-select" required >
				                                            <option value="<?php echo $basic->em_role; ?>" hidden><?php echo $basic->em_role; ?></option>
                                                    ...
                                                    <div class="form-group col-md-4 m-t-10">
                                                        ...
                                                        <select name="status" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> class="form-control custom-select" required >
				                                            <option value="<?php echo $basic->status; ?>" hidden><?php echo $basic->status; ?></option>
				                                    ...
				                                    <div class="form-group col-md-4 m-t-10">
				                                        ...
				                                        <input type="date" id="example-email2" name="dob" class="form-control mydatetimepickerFull" placeholder="" value="<?php echo $basic->em_birthday; ?>" required> 
				                                    </div>
				                                    <div class="form-group col-md-4 m-t-10">
				                                        <label>Contact Number </label>
				                                        <input type="text" class="form-control" placeholder="" name="contact" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> value="<?php echo $basic->em_phone; ?>" minlength="10" maxlength="10" required> 
				                                    </div>
                                                   	<?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?>  <?php } else { ?> 				                                    
				                                    <div class="form-group col-md-4 m-t-10">
				                                        <label>Department</label>
				                                        <select name="dept" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> class="form-control custom-select">
				                                            <option value="<?php echo $basic->id; ?>" hidden><?php echo $basic->dep_name; ?></option>
				                                    ...
				                                    <div class="form-group col-md-4 m-t-10">
				                                        ...
				                                        <select name="deg" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> class="form-control custom-select">
				                                            <option value="<?php echo $basic->id; ?>" hidden><?php echo $basic->des_name; ?></option>
				                                    ...
				                                    <div class="form-group col-md-4 m-t-10">
				                                        ...
				                                        <input type="date" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> id="example-email2" name="joindate" class="form-control mydatetimepickerFull" value="<?php echo $basic->em_joining_date; ?>" placeholder=""> 
				                                    </div>
													<div class="dtBox"></div>
				                                    <div class="form-group col-md-4 m-t-10">
				                                        <label>Date of leaving</label>
				                                        <input type="date" id="example-email2" name="leavedate" class="form-control mydatetimepickerFull" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> value="<?php echo $basic->em_contact_end; ?>" placeholder=""> 
				                                    </div>
													<div class="dtBox"></div>
				                                    <div class="form-group col-md-4 m-t-10">
				                                        <label>Email </label>
				                                    ...
				                                    <div class="form-actions col-md-12">
				                                        ...
				                                        <a class="btn btn-secondary" href="<?=base_url('employee')?>">Cancel</a>
				                                    </div>
				                                    <?php } ?>
				                                </form>
                                                </div>
                                    ...
                                    <div class="card">
				                        <div class="card-body">
			                                ...
			                                <form class="row" action="Parmanent_Address" method="post" enctype="multipart/form-data">
			                                    ...
			                                    <hr>
			                        		<!-- <h3 class="card-title mt-4">Present Contact Information</h3>
	                                    ...
	                                    <div class="card-body">
			                                <form class="row" action="Add_bank_info" method="post" enctype="multipart/form-data">
			                                    ...
			                                    <div class="form-group col-md-6 m-t-5">
			                                        ...
			                                        <input type="text" name="ifsc" value="<?php if(!empty($bankinfo->ifsc)) echo $bankinfo->ifsc ?>" class="form-control form-control-line" placeholder="11 characters IFSC code"> 
			                                    </div>
			                                    <div class="form-group col-md-6 m-t-5">
											...
											<table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
												...
												<?php foreach($fileinfo as $value): ?>
													<tr>
														...
														<td>
															<a onclick="return confirm('Are you sure to delete this data?')" href="<?php echo base_url();?>employee/Delete_doc/<?php echo $value->id;?>" title="Delete" class="btn btn-sm btn-danger waves-effect waves-light"><i class="fa fa-trash-o"></i></a>
														</td>
													</tr>
													<?php endforeach; ?>
												</tbody>
                                    ...
                                    <div class="card-body">
                                        <form class="row" action="Add_File" method="post" enctype="multipart/form-data">
                                            <div class="form-group col-md-6 m-t-5">
                                                ...
                                                <input type="text" name="title" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> class="form-control" required="" aria-invalid="false" minlength="2" required>
                                            </div>
                                            <div class="form-group col-md-6 m-t-5">
                                    ...
                                    <div class="card-body">
				                                <form class="row" action="Reset_Password_Hr" method="post" enctype="multipart/form-data">
				                                    <div class="form-group col-md-6 m-t-20">
				                                        ...
				                                        <input type="text" class="form-control" id="pwd" name="new1" value="" required minlength="6"> 
				                                    </div>
				                                    <div class="form-group col-md-6 m-t-20">
				                                        <label>Confirm Password</label>
				                                        <input type="text" id="" name="new2" class="form-control " equalTo="#pwd" required minlength="6"> 
				                                    </div>
				                                    <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?>
                                                    <?php } else { ?>
				                                    <div class="form-actions col-md-12">
                                    ...
                                    <div class="card-body">
				                                <form class="row" action="Save_Social" method="post" enctype="multipart/form-data">
				                                    <div class="form-group col-md-6 m-t-20">
				                                        ...
				                                        <input type="url" class="form-control" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> name="facebook" value="<?php if(!empty($socialmedia->facebook)) echo $socialmedia->facebook ?>" placeholder="Facebook profile URL"> 
				                                    </div>
				                                    <div class="form-group col-md-6 m-t-20">
				                                        <label>Instagram</label>
				                                        <input type="text" class="form-control" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> name="instagram" value="<?php if(!empty($socialmedia->instagram)) echo $socialmedia->instagram ?>"  placeholder="Instagram profile URL"> 
				                                    </div>
				                                    <div class="form-group col-md-6 m-t-20">
				                                        <label>Linkedin</label>
				                                        <input type="text" id="" name="linkedin" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> class="form-control " value="<?php if(!empty($socialmedia->linkedin)) echo $socialmedia->linkedin ?>" placeholder="LinkedIn profile URL"> 
				                                    </div>
				                                    <div class="form-group col-md-6 m-t-20">
				                                        <label>Skype</label>
				                                        <input type="text" id="" name="skype" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> class="form-control " value="<?php if(!empty($socialmedia->skype_id)) echo $socialmedia->skype_id ?>" placeholder="Skype profile URL"> 
				                                    </div>
				                                <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?>
                                                    <?php } else { ?>
				                                    <div class="form-actions col-md-12">
                                            ...
                                            <div class="form-group col-md-6 m-t-5">
                                                ...
                                                <select class="form-control <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> custom-select" data-placeholder="Choose a Category" tabindex="1" name="typeid" required>
                                                   <?php if(empty($salaryvalue->salary_type)){ ?>
                                                    <?php } else { ?>
                                                    <option value="<?php echo $salaryvalue->id; ?>" hidden><?php echo $salaryvalue->salary_type; ?></option>                         <?php } ?>                                      
                                                   <?php foreach($typevalue as $value): ?>
                                                    <option value="<?php echo $value->id; ?>" <?php echo $value->salary_type=='Monthly'?'selected':'' ?>><?php echo $value->salary_type; ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div> 
			                                    <div class="form-group col-md-6 m-t-5">
			                                    ...
			                                    <div class="row">
			                                    <div class="form-group col-md-6 m-t-5" style="display:none">
			                                        <label>Bima</label>
