                            ...
                            <div class="card-body">
                                ...
                                <form class="row" method="post" action="<?=$path?>" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group col-md-5 m-t-20">
                                        <label>Organisation <small>(will be printed on invoices & quotations)</small> <span class="req">*</span></label>
                                        <input type="text" name="name" value="<?=isset($client)?$client->name:''?>" class="form-control form-control-line" placeholder="Client's organisation name" minlength="2" required > 
                                    </div>
                                    <div class="form-group col-md-5 m-t-20">
                                        <label>Concerned person <span class="req">*</span></label>
                                        <input type="text" name="person" value="<?=isset($client)?$client->person:''?>" class="form-control form-control-line" placeholder="Concerned person" minlength="2" required > 
                                    </div>
									<div class="form-group col-md-5 m-t-20">
