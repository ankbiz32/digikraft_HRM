                            ...
                            <div class="card-body">
                                    <form method="post" action="<?php echo base_url();?>organization/Update_dep" enctype="multipart/form-data">
                                        ...
                                        <div class="form-actions">
											<button type="submit" class="btn btn-info mr-1"> <i class="fa fa-check"></i> Update</button>
                                            <a class="btn btn-secondary" href="<?php echo base_url();?>organization/Department">Cancel</a>
                                        </div>
                                    </form>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                    <form method="post" action="Save_dep" enctype="multipart/form-data">
                                        ...
                                        <div class="form-actions">
                                            ...
                                            <button type="reset" class="btn btn-secondary outline-none">Reset</button>
                                        </div>
                                    </form>
                            </div>
                        </div>
