                    ...
                    <div class="col-12">
                        ...
                        <div class="card card-outline-info">
                            <div class="card-header d-flex">
                                <h4 class="m-b-0 text-white"> Payroll List</h4>
								<a href="<?php echo base_url(); ?>Payroll/Generate_salary" class="text-white btn btn-sm btn-success ml-auto float-right"><i class="fa fa-plus"></i> Generate Payslip</a>
                                           ...
                                           <?php $i =0; foreach($salary_info as $individual_info): ?>
                                            <tr>
                                                ...
                                                <td class="jsgrid-align-center ">
                                                    ...
                                                    <a onclick="return confirm('Are you sure to delete this data?')" href="<?php echo base_url();?>payroll/Delete_payslip/<?php echo $individual_info->pay_id;?>" title="Delete" class="btn btn-sm btn-danger waves-effect waves-light"><i class="fa fa-trash-o"></i></a>
                                                </td>
                                            </tr>
                                            <?php endforeach; ?>
                                        </tbody>
