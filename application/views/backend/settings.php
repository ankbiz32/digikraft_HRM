                                ...
                                <div class="table_body">
                                    <form action="Add_Settings" id="fileUploadForm"  method="post" enctype="multipart/form-data" accept-charset="utf-8">
                                        <div class="form-group clearfix">
                                            <label for="img_url" class="col-md-3"><i class="fa fa-camera" aria-hidden="true"></i>  Upload site logo</label>
                                            <div class="col-md-9">
                                                ...
                                                <input type="file" value="" class="mt-2" id="img_url" name="img_url" aria-describedby="fileHelp">
                                            </div>
                                        </div>
                                        <div class="form-group clearfix">
